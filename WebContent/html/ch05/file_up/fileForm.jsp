    ...
    <form name="fileForm" action="fileUpload.jsp" method="post" enctype="multipart/form-data">
        <table border="1">
            <tr>
                ...
                <td width="100"><input type="text" name="user" id="user"><br></td>
            </tr>
            <tr>
            ...
            <tr>
                <td><label for="uploadFile">파일1</label></td>
                <td><input type="file" name="uploadFile" id="uploadFile" multiple><br></td>
            </tr>
            <tr>
                <td><label for="uploadFile2">파일2</label></td>
                <td><input type="file" name="uploadFile2" id="uploadFile2" multiple><br></td>
            </tr>
            <tr>
